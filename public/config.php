...
switch ($_SERVER['SERVER_ADDR'])
    {
		...
		default:
			// DIR
			define('DIR_APPLICATION', '/srv/httpd/emporiumcamisetas.com.br/public/catalog/');
			...
			define('DIR_LANGUAGE', '/srv/httpd/emporiumcamisetas.com.br/public/catalog/language/');
			define('DIR_TEMPLATE', '/srv/httpd/emporiumcamisetas.com.br/public/catalog/view/theme/');
